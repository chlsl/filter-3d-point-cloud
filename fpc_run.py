...
n = 8  # number of points (under which a pixel is rejected)
img_gsd = 1
...
# print('filter_xyz, time = ', end - start, ' seconds')

# start = timeit.default_timer()
filter_xyz_bis(xyz_array, r, n, img_gsd)
# end = timeit.default_timer()
# print('filter_xyz_bis, time = ', end - start, ' seconds')

# profiling conclusion:
# filter_xyz_bis where the NAN assignement is done with the c function is not
# faster, maybe even slightly slower.
